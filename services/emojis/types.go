...
type Service interface {
	...
	GetEntityStringEmoji(entityID string, entityType constants.EmojiEntity) string
	GetEntityEmoji(entityID string, entityType constants.EmojiEntity) *discordgo.ComponentEmoji
